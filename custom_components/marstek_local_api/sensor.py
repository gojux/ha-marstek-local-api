...
SENSOR_TYPES: tuple[MarstekSensorEntityDescription, ...] = (
    ...
    MarstekSensorEntityDescription(
        key="ct_net_import_energy",
        name="CT net import energy",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_fn=lambda data: _wh_to_kwh(data.get("em", {}).get("net_import_energy")),
        category="em",
    ),
    MarstekSensorEntityDescription(
        key="ct_net_export_energy",
        name="CT net export energy",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_fn=lambda data: _wh_to_kwh(data.get("em", {}).get("net_export_energy")),
        category="em",
    ),
    MarstekSensorEntityDescription(
        key="ct_parse_state",
